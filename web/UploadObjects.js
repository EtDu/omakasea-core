...
class NFTClass {
  ...
  renameAttribute(name1, name2) {
    this.nftClass.attributes[name2] = deepCopy(this.nftClass.attributes[name1]);
    this.deleteAttribute(name1);
  }

  deleteAttribute(name) {
    this.nftClass.nameIndex = this.nftClass.nameIndex.filter((n) => n !== name);
